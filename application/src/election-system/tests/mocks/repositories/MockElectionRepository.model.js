...
var MockElectionRepository = /** @class */ (function () {
    // TODO: Refactor event bus out so it gets injected into Election on creation by injection framework.
    function MockElectionRepository(mockData) {
        this._mockData = [];
        if (mockData !== undefined) {
            this._mockData = mockData;
        }
    }
    MockElectionRepository.prototype.add = function (entity) {
    ...
    MockElectionRepository.prototype.addRange = function (entities) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    MockElectionRepository.prototype.getPagedResults = function (pageSize, pageNumber) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    MockElectionRepository.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var index, removed;
            return __generator(this, function (_a) {
    ...
    return MockElectionRepository;
}());
exports.MockElectionRepository = MockElectionRepository;
//# sourceMappingURL=MockElectionRepository.model.js.map