...
var Survey = /** @class */ (function (_super) {
    ...
    function Survey(id, author, title, description, category, dateCreated, _questions) {
    ...
    Survey.create = function (idGenerator, sData) {
        ...
        return new Survey(idGenerator(), sData.author, sData.title, sData.description, new CategoryVO_model_1.CategoryVO(sData.category), new Date(), questions);
    };
