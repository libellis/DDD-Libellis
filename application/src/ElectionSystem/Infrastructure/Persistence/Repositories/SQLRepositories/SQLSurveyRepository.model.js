            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        survey = new MasterBallot_model_1.Survey(sData["id"], sData["author"], sData["title"], sData["description"], new CategoryVO_model_1.CategoryVO(sData["category"]), new Date(sData["datePosted"]), sData["anonymous"], sData["published"], []);
