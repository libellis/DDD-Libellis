...
var TestSurveyFactory = /** @class */ (function () {
    ...
    TestSurveyFactory.createBaseSurvey = function (surveyParams) {
        ...
        return new MasterBallot_model_1.Survey(sData.id, sData.author, sData.title, sData.description, new CategoryVO_model_1.CategoryVO(sData.category), sData.datePosted, sData.published, sData.anonymous, sData.questions);
    };
